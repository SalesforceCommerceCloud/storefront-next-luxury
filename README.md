...
git clone https://github.com/SalesforceCommerceCloud/storefront-next-luxury my-storefront
cd my-storefront
...
git clone --branch v1.0.0 --depth 1 \
  https://github.com/SalesforceCommerceCloud/storefront-next-luxury my-storefront
```
